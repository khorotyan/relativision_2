...
public class ViewerSpace : MonoBehaviour
{
    ...
    private void SpawnObjects()
    {
        ...
        if (Mathf.Abs(transform.position.z - maxPosZ) < 900)
        {
            ...
            float xPos1 = Random.Range(-25f, -60f);
            float xPos2 = Random.Range(25f, 60f);

            float zPos1 = Random.Range(90f, 150f);
            float zPos2 = Random.Range(90f, 150f);
